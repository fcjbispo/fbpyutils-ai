...
# Test cases for get_crawl_errors
@patch('fbpyutils_ai.tools.crawl.HTTPClient')
def test_get_crawl_errors_success(mock_http_client):
    # Arrange
    ...
    # Act
    errors = tool.get_crawl_errors(job_id)
...
@patch('fbpyutils_ai.tools.crawl.HTTPClient')
def test_get_crawl_errors_job_not_found(mock_http_client):
    # Arrange
    mock_client_instance = mock_http_client.return_value
...
@patch('fbpyutils_ai.tools.crawl.HTTPClient')
def test_get_crawl_errors_api_error(mock_http_client):
    # Arrange
    mock_client_instance = mock_http_client.return_value
    mock_client_instance.sync_request.side_effect = httpx.HTTPStatusError(
...
@patch('fbpyutils_ai.tools.crawl.HTTPClient')
def test_get_crawl_errors_connection_error(mock_http_client):
    # Arrange
    mock_client_instance = mock_http_client.return_value
